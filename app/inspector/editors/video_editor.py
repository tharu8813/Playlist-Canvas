"""Inspector editor for SourceType.VIDEO, split out of
...
def edit(inspector: "SourceInspector", source: Source) -> None:
    with editing(inspector, source):
        apply_image_backed_fields(inspector, source, show_file=False)
        inspector._set_field_visible("video_settings", True)
