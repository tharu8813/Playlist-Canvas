...
```text
output-setup\Playlist Canvas-1.2.0.1-setup.exe
```
...
- 태그는 `1.2.0.1`처럼 네 자리 버전 형식을 사용합니다. (`v` 접두사도 허용됩니다.)
...
1. `Playlist Canvas-1.2.0.1-setup.exe`로 설치와 제거가 정상 동작하는지 확인합니다.
